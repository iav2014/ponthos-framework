...
let start = () => {
	...
	//let _loaders = [mongoTestLoader.mongodbLoader]; //,mysqlLoader.mysqlLoader, redisLoader.redisLoader]; // if you don't have a mongo database o redis uncomment this line,,,

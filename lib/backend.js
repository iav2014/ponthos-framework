...
let start = () => {
	...
	// example for mongo db :let _loaders = [mongoTestLoader.mongodbLoader];
	// example for postgresql db :let _loaders = [postgresqlLoader.postgresqlLoader];
	// example for mongo db & redis & mysql: let _loaders = [mongoTestLoader.mongodbLoader,mysqlLoader.mysqlLoader,redisLoader.redisLoader];

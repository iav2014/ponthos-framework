...
var postgresqlLoader = require('./loader/postgresqlLoader');
var mysqlLoader = require('./loader/mysqlLoader');
...
function start() {
	...
	// var _loaders = [mysqlLoader.mysqlLoader, mongoTestLoader.mongodbLoader, postgresqlLoader.postgresqlLoader, redisLoader.redisLoader]; // if you don't have a mongo database o redis uncomment this line,,,
